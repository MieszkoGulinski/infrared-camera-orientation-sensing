...
const calculateBalance = (imageArray, width, height, temperatureThreshold) => {
  ...
  // - If a pixel belongs to the lower half of the image, and is identified as Earth (value 1), it is marked as "correct" (0).
  // - Otherwise, a pixel is marked as incorrect (1).
