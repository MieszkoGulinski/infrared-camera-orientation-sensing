...
// Should return that the satellite is correctly oriented and does not need to be rotated.
...
// Case 2: The satellite is slightly rotated in the axis perpendicular to the camera direction. The upper half of the image shows the sky AND Earth, and the lower half shows Earth.
...
// Case 5: The satellite is rotated in the axis perpendicular to the camera direction. The upper half of the image shows the sky, and the lower half shows Earth and sky.
...
// Case 8 (degenerate): only sky is visible.
